...
public class MyGameManagerAddr : MonoBehaviour
{
    public Text dtext;
    ...
    public void dprint(string str)
    {
        ...
        if (++dcount > 1000){
            print("dtext length" + dtext.text.Length);
            dtext.text = "CLEARED\n" + dtext.text.Substring(dtext.text.Length/2);
            //really should add code to strip until a full line
            dcount = 0;
        }
...
//                            FixedUpdate1();
    ...
    IEnumerator ExecuteCommands(string [] commands,int startnum = 0 )
    {
        ...
        for (int i = 0; i < commands.Length; i++)
        {
            ...
            cs.commandNum=i;
            dprint(""+ cs.commandNum + ": " + cs.commandLine);
            ...
            dprint(""+ cs.commandNum + " DO: " + cs.commandLine);
...
//        return null;
    ...
    bool processObjectsCommand(string objName,string command,string cparams)
    {
        ...
        {  //only call for named GameObject
            ...
            if (!go)
            {
                print("ERROR: Object " + objName + " not found.");
                retval = false;
                return retval;
            }
...
print("FU1.4");
    ...
    public bool displayLastCommands = false;
    void OnGUI() {
        ...
        //Display last two commands
        if (displayLastCommands && GUIcommandLine != null)
        {
...
//           GUI.Label(new Rect(10, 10, 100, 20), cs.commandLine );
        ...
        //Dialog Prompt1 & Prompt 2 commands
        int border = 10;
